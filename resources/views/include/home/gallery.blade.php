        ...
        <div class="row multi-columns-row ttm-boxes-spacing-5px style2 mt_65 g-0">
                ...
                <div class="featured-imagebox featured-imagebox-portfolio">
                    ...
                    <div class="ttm-box-view-overlay">
                        <div class="ttm-media-link">
                            <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="Autue Art Gallery Opening" href="{{asset('images/gallery/gallery-1.jpg')}}" data-rel="prettyPhoto">
            ...
            <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                ...
                <div class="featured-imagebox featured-imagebox-portfolio">
                    ...
                    <div class="ttm-box-view-overlay">
                        <div class="ttm-media-link">
                            <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="Grand Despa Events" href="{{asset('images/gallery/gallery-5.jpg')}}" data-rel="prettyPhoto">
                                <i class="ti ti-search"></i>
                            </a>
                        </div>
                        <div class="featured-content featured-content-portfolio">
            ...
            <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                ...
                <div class="featured-imagebox featured-imagebox-portfolio">
                    ...
                    <div class="ttm-box-view-overlay">
                        <div class="ttm-media-link">
                            <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="Divqi Holiday Party" href="{{asset('images/gallery/gallery-2.jpg')}}" data-rel="prettyPhoto">
                                <i class="ti ti-search"></i>
                            </a>
                        </div>
                        <div class="featured-content featured-content-portfolio">
            ...
            <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                ...
                <div class="featured-imagebox featured-imagebox-portfolio">
                    ...
                    <div class="ttm-box-view-overlay">
                        <div class="ttm-media-link">
                            <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="Helen Birthday Party" href="{{asset('images/gallery/gallery-3.jpg')}}" data-rel="prettyPhoto">
                                <i class="ti ti-search"></i>
                            </a>
                        </div>
                        <div class="featured-content featured-content-portfolio">
            ...
            <div class="ttm-box-col-wrapper col-lg-4 col-md-6">
                ...
                <div class="featured-imagebox featured-imagebox-portfolio">
                    ...
                    <div class="ttm-box-view-overlay">
                        <div class="ttm-media-link">
                            <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="Kids Birthday Party" href="{{asset('images/gallery/gallery-8.jpg')}}" data-rel="prettyPhoto">
                                <i class="ti ti-search"></i>
                            </a>
                        </div>
                        <div class="featured-content featured-content-portfolio">

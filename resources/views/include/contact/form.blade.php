<section class="ttm-row contact-form-section2 bg-layer break-991-colum clearfix">
    <div class="container">
        <div class="row res-1199-mlr-15 g-0">
            <div class="col-md-4 col-lg-4">
                ...
                <img src="{{asset('images/bg-image/col-bgimage-3.jpg')}}" class="ttm-equal-height-image" alt="bg-image">
            </div>
                ...
                <div class="padding-12 box-shadow">
                    ...
                    <form id="contactform" class="row contactform wrap-form clearfix" method="post"
                        ...
                        <label class="col-md-6">
                            ...
                            <span class="ttm-form-control"><input class="text-input" name="name" type="text"

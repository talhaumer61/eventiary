                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-md avatar-rounded">
                                                <img src="{{asset('dashboard/images/ecommerce/png/1.png')}}" alt="">
                                            </span>
                                        </div>
                                        <div class="fw-medium">
                                            Yellow sling bag
                            ...
                            <tr class="product-list">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-md avatar-rounded">
                                                <img src="{{asset('dashboard/images/ecommerce/png/2.png')}}" alt="">
                                            </span>
                                        </div>
                                        <div class="fw-medium">
                            ...
                            <tr class="product-list">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-md avatar-rounded">
                                                <img src="{{asset('dashboard/images/ecommerce/png/15.png')}}" alt="">
                                            </span>
                                        </div>
                                        <div class="fw-medium">
                                            Orange Smart Watch
                            ...
                            <tr class="product-list">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-md avatar-rounded">
                                                <img src="{{asset('dashboard/images/ecommerce/png/3.png')}}" alt="">
                                            </span>
                                        </div>
                                        <div class="fw-medium">
                            ...
                            <tr class="product-list">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-md avatar-rounded">
                                                <img src="{{asset('dashboard/images/ecommerce/png/4.png')}}" alt="">
                                            </span>
                                        </div>
                                        <div class="fw-medium">
                            ...
                            <tr class="product-list">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-md avatar-rounded">
                                                <img src="{{asset('dashboard/images/ecommerce/png/13.png')}}" alt="">
                                            </span>
                                        </div>
                                        <div class="fw-medium">
                            ...
                            <tr class="product-list">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-md avatar-rounded">
                                                <img src="{{asset('dashboard/images/ecommerce/png/12.png')}}" alt="">
                                            </span>
                                        </div>
                                        <div class="fw-medium">
                                            Sweater For Women
                            ...
                            <tr class="product-list">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-md avatar-rounded">
                                                <img src="{{asset('dashboard/images/ecommerce/png/16.png')}}" alt="">
                                            </span>
                                        </div>
                                        <div class="fw-medium">
                            ...
                            <tr class="product-list">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-md avatar-rounded">
                                                <img src="{{asset('dashboard/images/ecommerce/png/23.png')}}" alt="">
                                            </span>
                                        </div>
                                        <div class="fw-medium">

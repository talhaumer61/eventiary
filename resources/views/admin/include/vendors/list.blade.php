            ...
            <div class="card custom-card text-center">
                <div class="card-body p-4">
                    ...
                    {{-- <div class="d-flex align-items-center justify-content-center gap-2">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-sm btn-icon btn-outline-light btn-wave border" type="button" data-bs-toggle="dropdown">
                        ...
                        <button class="btn btn-sm btn-icon btn-outline-light border"><i class="ri-heart-3-fill text-danger"></i></button>
                    </div> --}}
                </div>
            </div>
        </div>

<div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Vendor Type</h1>
        <div class="">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Vendors</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Add Vendor Type</li>
                </ol>
            </nav>
        </div>
    </div>
...
<!-- Start::row-1 -->
<div class="row">
    <form action="{{route('addVendorType')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="col-xl-12">

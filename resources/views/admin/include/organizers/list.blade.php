<div class="row">
            ...
            <div class="card-body">
                <div class="contact-header">
                    <div class="d-sm-flex d-block align-items-center justify-content-between">
                        <div class="h5 fw-medium mb-0">Registered Organizers</div>
        ...
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/4.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/15.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        William
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/2.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Charlotte
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/13.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Christopher
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/9.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Steven
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/5.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Isabella
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/10.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Thomas
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/21.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Amelia
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/11.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Richard
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/12.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Benjamin
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/1.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Victoria
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/8.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Sophia
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/14.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Michael
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/7.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Harper
    ...
    <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6">
        <div class="card custom-card text-center">
            <div class="card-body p-4">
                <div class="avatar avatar-xl avatar-rounded mb-3">
                    <img src="{{asset('dashboard/images/faces/6.jpg')}}" alt="" class="img-thumbnail">
                </div>
                <div class="mb-3">
                    <h6 class="mb-1 fw-medium">
                        Grace

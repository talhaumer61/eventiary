            ...
            <div class="card-body add-products p-0">
                <form action="{{ route('guests.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row gy-3">
                                            <div class="col-xl-6">
                                                ...
                                                <input type="text" class="form-control" id="product-name-add" name="name">
                                            </div>
                                            <div class="col-xl-6">
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <input type="text" class="form-control" name="address" id="product-cost-add">
                                            </div>
                    ...
                    <div class="px-4 py-3 border-top border-block-start-dashed d-sm-flex justify-content-end">
                        <button class="btn btn-success-light m-1">Add Guest<i class="bi bi-check-lg ms-2"></i></button>
                    </div>
                </form>

...
<div class="row">
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{ route('organizer.portfolio.update', $portfolio->id) }}" 
                    method="POST" enctype="multipart/form-data">

                    @csrf

                    <label>Title</label>
                    <input name="title" value="{{ $portfolio->title }}" class="form-control" required>
                    ...
                    <br>
                    <img src="{{ asset($portfolio->image) }}" width="150" style="border-radius:8px">

                    <label class="mt-3">Replace Image (optional)</label>

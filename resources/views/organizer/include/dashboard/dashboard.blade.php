                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <span class="avatar avatar-lg">
                                        <img src="dashboard/images/faces/4.jpg" alt="img" class="">
                                    </span>
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="text-muted d-flex fs-11 align-items-center">
                                                <span class="avatar avatar-xs me-1 avatar-rounded">
                                                    <img src="dashboard/images/faces/21.jpg" alt="img" class="">
                                                </span>
                                                Mayor Kelly
                                            </div>
                                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card custom-card mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <span class="avatar avatar-lg">
                                        <img src="dashboard/images/faces/1.jpg" alt="img" class="">
                                    </span>
                                    <div>
                    ...
                    <div class="swiper-slide">
                        <div class="card custom-card mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <span class="avatar avatar-lg">
                                        <img src="dashboard/images/faces/2.jpg" alt="img" class="">
                                    </span>
                                    <div>
                    ...
                    <div class="swiper-slide">
                        <div class="card custom-card mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <span class="avatar avatar-lg">
                                        <img src="dashboard/images/faces/3.jpg" alt="img" class="">
                                    </span>
                                    <div>
                    ...
                    <div class="swiper-slide">
                        <div class="card custom-card mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <span class="avatar avatar-lg">
                                        <img src="dashboard/images/faces/8.jpg" alt="img" class="">
                                    </span>
                                    <div>
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-sm me-2 avatar-rounded">
                                            <img src="dashboard/images/faces/4.jpg" alt="img">
                                        </span>Mayor Kelly
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-sm me-2 avatar-rounded">
                                            <img src="dashboard/images/faces/3.jpg" alt="img">
                                        </span>Kamala Hars
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-sm me-2 avatar-rounded">
                                            <img src="dashboard/images/faces/1.jpg" alt="img">
                                        </span>Melissa Smith
                                    </div>
                                </td>
                                <td>
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-rounded avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Taylor Singh">
                                            <img src="dashboard/images/faces/5.jpg" alt="img">
                                        </span>
                                ...
                                <td>
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-rounded avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Van Bode">
                                            <img src="dashboard/images/faces/7.jpg" alt="img">
                                        </span>
                                    </div>
                                </td>
                                <td>31</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-rounded avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Taylor Singh">
                                            <img src="dashboard/images/faces/9.jpg" alt="img">
                                        </span>
                                        <span class="avatar avatar-rounded avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Van Bode">
                                            <img src="dashboard/images/faces/3.jpg" alt="img">
                                        </span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-rounded avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Taylor Singh">
                                            <img src="dashboard/images/faces/10.jpg" alt="img">
                                        </span>
                                    </div>
                                </td>
                                <td>20</td>

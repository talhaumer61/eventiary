            ...
            <div class="card-body">
                <div class="contact-header">
                    <div class="d-sm-flex d-block align-items-center justify-content-between">
                        <div class="h5 fw-medium mb-0">Booking Requests</div>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-body">
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p><strong>Service:</strong> {{ $assignment->service->service_name }}</p>
                                            {{-- <p><strong>Email:</strong> {{ $assignment->client->email }}</p> --}}
                                            ...
                                            <p><strong>Estimated Guests:</strong> {{ $assignment->event->no_of_guests }}</p>
                                            <p><strong>Date:</strong> {{ \Carbon\Carbon::parse($assignment->event->event_date)->format('d M Y') }}</p>
                                        </div>

                                        <div class="modal-footer">
                                            @if ($assignment->status == 3)
                                                <form method="POST" action="{{ route('vendor.request-action') }}">
                                                    @csrf
                ...
                @else
                    <div class="alert alert-danger mb-0">No booking requests found.</div>
                @endif
            </div>

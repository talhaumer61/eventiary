...
<div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Add Service</h1>
        <div class="">
            <nav>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-body add-products p-0">
                <form action="{{ route('vendor.storeService') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="p-4">
                        <div class="row gx-5">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <textarea class="form-control" name="service_desc" id="service_desc" rows="4"></textarea>
                                            </div>
                        ...
                        <div class="px-4 py-3 border-top border-block-start-dashed d-sm-flex justify-content-end">
                            <button class="btn btn-success-light m-1">Add Service <i class="bi bi-check-lg ms-2"></i></button>
                        </div>
                    </div>
                </form>

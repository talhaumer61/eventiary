...
<head>
    ...
    <title> Register Vendor - Eventiary </title>
            ...
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                <div class="card custom-card my-4">
                    <div class="card-body p-5">
                        <p class="h5 mb-2 text-center">Become a Vendor</p>
                        <p class="mb-4 text-muted op-7 fw-normal text-center">Welcome & Join us by creating  account !</p>
                        
                        <form action=" {{ route('vendorSignup') }} " method="post" onsubmit="return validateSignupForm()">
                            @csrf
                            <div class="row gy-3">
                                <div class="col-xl-12">
